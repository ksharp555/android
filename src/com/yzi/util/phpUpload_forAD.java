...
public class phpUpload_forAD {
	private static final String CHARSET = "utf-8";
	private static final String upLoadServerUri="http://104.236.202.116/php/supplyndemand/uploadinf.php";
	int serverResponseCode = 0;
	
	
	public phpUpload_forAD(){
		
	}
	public int uploadFile(List<String> sourceFileUri, String lat, String longi, String userid, String content, String title, String pdate, String endDate, String viewRange){
        	...
        	try{
               ...
               // send multipart form data necesssary after file data...
        		...
        		//Log.i("URLwithParameters", "URLwithParameters:****************"+upLoadServerUri+"?lat="+lat+"&longi="+longi+
        			//	"&dat="+"&typeid="+typeid+"&username="+username);
        		...
        		for(int i = 0;i < sourceFileUri.size(); i++){
        			File file = new File(sourceFileUri.get(i));
        			Log.i("filepath------------", sourceFileUri.get(i));
        		...
        		Log.i("upload content", "pdate is"+pdate+"\n endtime is "+endDate+"\n view range is"+viewRange);
        		reqEntity.addPart("userid", new StringBody(userid));
        		reqEntity.addPart("description", new StringBody(content));
        		reqEntity.addPart("title", new StringBody(title));
        		reqEntity.addPart("pdate", new StringBody(pdate));
        		reqEntity.addPart("endtime", new StringBody(endDate));
        		reqEntity.addPart("viewrange", new StringBody(viewRange));
